  ...
  return (
    <>
      <div className={styles.boxRow}>
        ...
        <div>
          <h1>$ {concept.qty * concept.price}</h1>
        </div>
        {/* <div>
          {user ? (
      ...
      <Confirm open={showConfirm} cancelButton="Cancelar" onConfirm={onDelete} onCancel={openCloseConfirm} content="¿ Estas seguro de eliminar el concepto ?" />
